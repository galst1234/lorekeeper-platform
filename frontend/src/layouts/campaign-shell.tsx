...
import { Backpack, LayoutDashboard, Menu, Settings, Users } from "lucide-react";
...
export function CampaignShell({ slug, children }: CampaignShellProps) {
  ...
  const sidebarItems = (
    <>
      ...
      />
      <NavItem to="/campaigns/$slug/items" params={{ slug }} icon={Backpack} label="Items" badge={items.length} />
