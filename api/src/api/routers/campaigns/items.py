...
from api.models import CampaignMember, Item
...
async def list_items(
    ...
    items = await item_service.list_items(db, member.campaign_id)
...
async def get_item(
    ...
    item = await item_service.get_item_by_slug(db, member.campaign_id, item_slug)
    if item is None:
